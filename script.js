$(document).ready(function() {
  ...
  function createPanel(HNurl, title) {
    // We found the article on Hackernews. 
    // TODO change the tab to deal with the browser icon instead
  
    console.log("createPanel - it's on Hackernews, URL is " + HNurl + " and tht title is ") 
